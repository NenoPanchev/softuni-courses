...
public class FieldImpl implements Field {
    ...
    public String start(Collection<Player> players) {
        ...
        while (!terrorists.isEmpty() && !counterTerrorists.isEmpty()) {
            teamAttacksTheOtherTeam(terrorists, counterTerrorists, players);
            if (!counterTerrorists.isEmpty()) {
                teamAttacksTheOtherTeam(counterTerrorists, terrorists, players);
            }
        }
    ...
    private void teamAttacksTheOtherTeam(List<Player> attackers, List<Player> defenders, Collection<Player> everyone) {
