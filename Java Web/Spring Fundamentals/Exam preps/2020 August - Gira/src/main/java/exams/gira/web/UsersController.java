...
import exams.gira.model.binding.UserLoginBindingModel;
...
public class UsersController {
    ...
    public String loginConfirm(@Valid @ModelAttribute("userLoginBindingModel")UserLoginBindingModel userLoginBindingModel,
        ...
        UserServiceModel userServiceModel = this.userService.getByEmailAndPassword(userLoginBindingModel.getEmail(), userLoginBindingModel.getPassword());
