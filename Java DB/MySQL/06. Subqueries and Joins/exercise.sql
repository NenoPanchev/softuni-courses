...
CONCAT(em.first_name, ' ', em.last_name) AS manager_name, d.`name` AS department_name
FROM employees AS e
JOIN employees AS em
ON e.manager_id = em.employee_id
JOIN departments AS d
...
HAVING currency_usage > 1
    ...
    FROM
        countries AS cr
    WHERE
        cr.continent_code = c.continent_code
    GROUP BY cr.currency_code , cr.continent_code
