...
import course.springdata.xmlprocessingex2.models.dtos.export.CarExportWithoutIdDto;
import course.springdata.xmlprocessingex2.models.dtos.export.CarSimpleViewDto;
import course.springdata.xmlprocessingex2.models.dtos.export.SaleExportFullInfoDto;
import course.springdata.xmlprocessingex2.models.dtos.export.SaleViewRootDto;
import course.springdata.xmlprocessingex2.models.entities.Sale;
import course.springdata.xmlprocessingex2.repositories.SaleRepository;
...
import course.springdata.xmlprocessingex2.services.SaleService;
...
public class SaleServiceImpl implements SaleService {
    ...
    @Override
    public SaleViewRootDto getSalesWithAppliedDiscount() {
        List<SaleExportFullInfoDto> dtos = this.saleRepository.findAll()
                .stream()
                .map(sale -> {
                    SaleExportFullInfoDto dto = this.modelMapper.map(sale, SaleExportFullInfoDto.class);
                    dto.setCar(this.modelMapper.map(sale.getCar(), CarSimpleViewDto.class));
        ...
        SaleViewRootDto rootDto = new SaleViewRootDto();
